                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>Usia</td>
                                <td><?php echo e($datas->usia); ?></td>
                            </tr>
                        </table>
                        <h5>CHECK-UP</h5>
                        <div class="form-group">
                                    <label for="keluhan">Keluhan</label>
                                    <input class="form-control" type="text" name="keluhan" placeholder="isi keluhan anda" value="<?php echo e(old('keluhan')); ?>">
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="tinggi_badan">Tinggi Badan</label>
                                    <div class="col-md-4">
                                      <input class="form-control" type="number" placeholder="Kg" name="tinggi_badan" value="<?php echo e(old('tinggi_badan')); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="berat_badan">Berat Badan</label>
                                    <div class="col-md-4">
                                      <input class="form-control" type="number" placeholder="Kg" name="berat_badan" value="<?php echo e(old('berat_badan')); ?>">
                                    </div>
                                </div>
                                    <form>
                                      <div class="form-group row">
...
</html><?php /**PATH C:\xampp\htdocs\self_care\resources\views/proses.blade.php ENDPATH**/ ?>