                        ...
                        <div class="card-body">
                            ...
                            <form action="/proses" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="tgl_lahir" value="<?php echo e(old('tgl_lahir')); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <input class="form-control" type="text" name="alamat" value="<?php echo e(old('alamat')); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Usia</label>
                                    <input class="form-control" type="text" name="usia" value="<?php echo e(old('usia')); ?>">
                                </div>
                                <div class="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\self_care\resources\views/data.blade.php ENDPATH**/ ?>